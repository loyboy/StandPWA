...
export default class SusRecordModal extends React.PureComponent {
 //abbreviation - mne_
  render() {
    ...
    return (
      ...
      <div className="modal-card">
        ...
        <header className="modal-card-head">
          <p className="modal-card-title">  Sustainability >> Records </p>
        ...
        <div className="field">
          <label className="label">  Records warehousing Equipment? </label>
          <p className=" help"> Is there dedicated resource to hold school records? </p>
